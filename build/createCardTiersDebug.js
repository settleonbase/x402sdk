...
exports.emitCreateCardTiersJson = emitCreateCardTiersJson;
function shouldLogCreateCardTiersJson() {
    if (typeof process === 'undefined')
        return false;
    const e = process.env;
    return (e.BEAMIO_CREATE_CARD_LOG_TIERS === '1' ||
 ...
 */
function emitCreateCardTiersJson(where, tiers) {
    if (!shouldLogCreateCardTiersJson())
        return;
