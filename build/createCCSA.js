...
async function main() {
    ...
    const cardOwner = process.env.CARD_OWNER
        ? ethers_1.ethers.getAddress(process.env.CARD_OWNER)
        : ethers_1.ethers.getAddress(CARD_ISSUER_ADDRESS);
    const factoryAddr = await factory.getAddress();
    const factoryOwner = (await factory.owner());
    const baseRpc = (0, util_1.resolveBeamioBaseHttpRpcUrl)();
    ...
    const cardAddress = await (0, CCSA_1.createBeamioCardWithFactory)(factory, cardOwner, 'CAD', ONE_CAD_E6, {});
